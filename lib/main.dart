...
import 'package:next_data/core/config/firebase_options.dart';
...
import 'package:next_data/routes.dart' as router;
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async{
   ...
   var res =  await AuthService().signUpWithEmail("hamdi5@gmail.com", "12345678952222");
